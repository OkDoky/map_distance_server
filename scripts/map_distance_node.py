...
class MapDistanceServer:
    def __init__(self):
        ...
        distance_map_path = rospy.get_param("~distance_map_file","distance_map.png")

        rospy.wait_for_service("static_map", timeout=2.0)
    ...
    def _get_map_with_distances(self):
        ...
        # nearest distance + 1 (cell is one fmore step away from obstacle than
        # neighbor) 
